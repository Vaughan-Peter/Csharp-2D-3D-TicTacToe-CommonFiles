...
namespace CommonTicTacToe
{
    public class myModel
    {
        ...
        public virtual void SetRND_Velocity()
        {
        ...
        {
            // Max movement boundary
            float max = 200;

            // 3D movement logic
            pos = pos + vel;

            // Reflect velocity when boundaries are hit
        ...
        public virtual Texture2D CreateTexture(int width, int height, Color paint)
        {
        ...
        public virtual void draw(Vector3 cameraPosition, float aspectRatio, Vector3 cameraTarget, Vector3 cameraUpDirection, bool won = false)
        {
